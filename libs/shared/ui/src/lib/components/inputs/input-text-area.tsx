...
export function InputTextArea(props: InputTextAreaProps) {
  ...
  const isDisabled = props.disabled
    ? 'input--disabled !border-neutral-250'
    : ''
    ...
    >
      ...
      >
        ...
        <textarea
          ...
          rows={rows}
          id={label}
          className="w-full min-h-[52px] mt-5 pr-3 bg-transparent border-0 appearance-none focus:outline-0 text-sm focus:outline-none text-neutral-400 outline-0"
          value={currentValue}
          onChange={(e) => {
