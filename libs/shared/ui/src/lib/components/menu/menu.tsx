...
export interface MenuProps {
  ...
  header?: ReactNode;
  onClose?: (
    e: MenuCloseEvent | MouseEvent<HTMLDivElement, MouseEvent>
  ) => void;
  width?: number;
  paddingMenuY?: number;
  paddingMenuX?: number;
...
export function Menu(props: MenuProps) {
  ...
  //const menuStringify = JSON.stringify(menus, ignoreCircularReferences())
  ...
  const menusMemo = useMemo(
    ...
    [isFilter, menus, paddingMenuX, paddingMenuY, width]
  )
