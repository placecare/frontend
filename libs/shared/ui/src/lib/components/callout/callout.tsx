...
type CalloutIconProps = ComponentPropsWithoutRef<'div'>
...
type CalloutTextProps = ComponentPropsWithoutRef<'p'>
...
type CalloutTextHeadingProps = ComponentPropsWithoutRef<'span'>
